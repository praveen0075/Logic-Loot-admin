...
abstract class IproductRepo{
  Future<Either<Failure,AddproductResponseModel>> addProduct({required AddproductModel productModel});
  Future<Either<Failure,GetAllproductResponseModel>> getAllProduct();
}