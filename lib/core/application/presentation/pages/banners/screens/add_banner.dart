  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PreferredSize(
          ...
          child: AppBarWidget(title: "Add Banner")),
      body: Center(
              ...
              children: [
                ...
                Container(
                    ...
                    child: AddButton(onpressed: () {
                      if(_image == null){
                        snackBarWidget(context: context, msg: "Please select an image", bgColor: Colors.red);
                      }else{
                        context.read<BannerBloc>().add(BannerEvent.addBanner(imageUrl: _image!));
                      }
                    }, txt: "Add Banner"))
              ],
            );
